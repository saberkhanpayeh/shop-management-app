  ...
  return (
    <div className={styles.container}>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <input type={showPassword ? "text":"password"} {...register("password")} placeholder="رمز عبور" />
          {!showPassword ?<button onClick={()=>setShowPassword(true)}>
          ...
          {showPassword?<button onClick={()=>setShowPassword(false)}>
        ...
        <input type={showPassword ? "text":"password"} {...register("password")} {...register("confirmPassword")} placeholder="تکرار رمز عبور" />
        {errors?.confirmPassword && <span>*{errors?.confirmPassword.message}</span>}
        <button className={styles.submit} type="submit">ثبت نام</button>
      </form>
